export function planning (){
       ...
       <div className=" min-h-screen">
          <div className="text-center">
             <h1 className=" text-[#2DD4BF] font-bold font-serif text-5xl p-5">FESTIVAL PLANING</h1>
             <h3 className=" text-[#F5C542] font-medium text-2xl pb-7 ">Friday 19 MAY 2026</h3> 
             </div>

       <div className="m-9 space-y-3 border-2 p-6 rounded-2xl shadow-sm border-white">

        <div className="flex justify-between items-center mb-6">

      </div>

      <div className=" flex justify-between p-3  border-gray-400 rounded-2xl">
